...
% log model evidence of CIGPLVM(conditional independent GP latent model):
% given the kernel and noise paramters, each outputs are independent GPs
% 
...
% D = Y*Y';
% a0, b0: hyper parameters of Beta distribution as noise prior 
% 
% Author: Wei Xing 
